...
function ResourceButton({ name, link, extension }) {
  ...
  return (
    <button
      ...
      className="mr-2 group inline-flex flex-row border-2 border-blue-500 rounded-full px-2.5 py-1.5 text-xs space-x-3 items-center justify-center hover:bg-blue-500 hover:text-white"
    >
      <span>{name}</span>
