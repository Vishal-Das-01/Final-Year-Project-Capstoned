...
function ListTile({ name, group, progress, onClick }) {
  return (
    <Link href="current/123" className="font-montserrat mb-4 mt-1 mx-1 h-1/5 rounded-xl shadow-lg bg-gray-100 hover:bg-gray-300 grid grid-cols-5 items-center justify-between px-5 text-lg">
