	...
	const getNotifications = async () => {
		try {
			const response = await callAPI(
				...
				`${BACKEND_ROUTES.getStudentNotifications}?page=${page}`
			);
